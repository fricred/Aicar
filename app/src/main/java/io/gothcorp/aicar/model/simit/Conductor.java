...
public class Conductor implements Serializable {
    ...
    private List<LicenciaSimit> licenciaSimitList;
    ...
    public List<LicenciaSimit> getLicenciaSimitList() {
        return licenciaSimitList;
    }

    public void setLicenciaSimitList(List<LicenciaSimit> licenciaSimitList) {
        this.licenciaSimitList = licenciaSimitList;
    }
    ...
    public String toString() {
        return "co.com.simit.local.domain.Conductor[ conductorId=" + conductorId + " ]";
    }
